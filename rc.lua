...
local layouts = { l.tile, l.tile, l.tile, l.floating, l.floating, l.floating, l.floating }

-- Change spacing between tags
...
globalkeys = gears.table.join(
    ...
    awful.key({ }, "XF86AudioStop", function() awful.spawn("playerctl pause") end,
              {description = "pause audio", group = "Playerctl"}),
    awful.key({ }, "XF86AudioPlay", function() awful.spawn("playerctl play-pause") end,
              {description = "play/pause audio", group = "Playerctl"}),

    awful.key({ }, "XF86AudioRaiseVolume", function() awful.spawn("pamixer -i 2") end,
              {description = "raise volume", group = "Pamixer"}),
    awful.key({ }, "XF86AudioLowerVolume", function() awful.spawn("pamixer -d 2") end,
              {description = "lower volume", group = "Pamixer"}),
    awful.key({ }, "XF86AudioMute", function() awful.spawn("pamixer -t") end,
              {description = "mute volume", group = "Pamixer"})
)
